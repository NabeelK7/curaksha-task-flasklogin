...
engine=create_engine("mysql+pymysql://root:root@localhost/authenticate")	#mysql+pymysql://username:password@localhost/databasename
    ...
    if request.method=="POST":
        ...
        if usernamedata[0] is None:
            ...
            if password == passworddata[0]:
                ...
                return redirect(url_for('welcome')) #Opens welcome screen
            else:
